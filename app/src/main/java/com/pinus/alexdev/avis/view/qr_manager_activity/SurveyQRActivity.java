...
public class SurveyQRActivity extends BaseToolbarBack {
    private static final String TAG = SurveyQRActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_qr);
        ButterKnife.bind(this);
        setButtonBackClick(
                appbar.findViewById(R.id.appBarTitle),
                getResources().getString(R.string.surveyTitle) + " QR",
