package com.pinus.alexdev.avis.view.billing_activity;
...
public class BillingActivity extends BaseNavigationView implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitleAndLogoClick(appbar.findViewById(R.id.appBarTitle), R.string.menuBilling, appbar.findViewById(R.id.logoImageApp));

        saveLoadData = new SaveLoadData(this);

        userSummaryResponse = getUserSummaryInfo(getApplicationContext());

        navigationView = findViewById(R.id.nvViewBilling);
