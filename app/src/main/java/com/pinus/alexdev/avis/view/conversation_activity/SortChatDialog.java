...
public class SortChatDialog extends AppCompatDialogFragment {
    public static final int SORT_BY_NUMBER = 1;
    public static final int SORT_BY_DATE = 2;
    public static final int SORT_BY_RATING = 3;

    private SortChatDialogListener listener;

    public interface SortChatDialogListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.sort_chat_dialog, null);
    ...
    public void onAttach(Context context) {
        ...
        try {
            listener = (SortChatDialogListener) context;
        } catch (ClassCastException e) {
            throw new ClassCastException(context.toString() + "must implement SortChatDialogListener");
        }
    }
}
