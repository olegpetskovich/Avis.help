...
public class CameraSource {
     ...
     */
    private static final int DUMMY_TEXTURE_NAME = 10000;
     ...
     */
    private static final float ASPECT_RATIO_TOLERANCE = 1f;
    ...
    private int mRequestedPreviewHeight = 1080;
    ...
    public static class Builder {
        ...
        public Builder setParams(@FocusMode String mode){
        ...
        synchronized (mCameraLock) {
            if (mCamera != null && mode != null) {
                ...
                if (parameters.getSupportedFocusModes().contains(mode)) {
                    ...
                    parameters.setJpegQuality(1000);
                    mCamera.setParameters(parameters);
                    mFocusMode = mode;
                    return true;
                }
